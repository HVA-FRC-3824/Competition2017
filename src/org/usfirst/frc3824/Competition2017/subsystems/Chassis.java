...
public class Chassis extends Subsystem
{
    ...
    private final CANTalon leftMidMotor = RobotMap.chassisLeftMidMotor;
    private final CANTalon leftBackMotor = RobotMap.chassisLeftBackMotor;
    private final CANTalon rightFrontMotor = RobotMap.chassisRightFrontMotor;
    private final CANTalon rightMidMotor = RobotMap.chassisRightMidMotor;
    private final CANTalon rightBackMotor = RobotMap.chassisRightBackMotor;
	...
	public class EncoderPIDOutputRight implements PIDOutput
	{
		...
		public void pidWrite(double PIDoutput)
		{
			rightFrontMotor.set(PIDoutput + m_magnitude);
	...
	public class EncoderPIDOutputLeft implements PIDOutput
	{
		...
		public void pidWrite(double PIDoutput)
		{
			leftFrontMotor.set(-PIDoutput + m_magnitude);
