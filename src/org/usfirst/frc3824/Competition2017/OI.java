...
public class OI
{
	...
	public OI()
	{
        ...
        gearPlace = new JoystickButton(controllerJoystick, 13);
        gearPlace.whenPressed(new PlaceGear());
        gearIntakeStation = new JoystickButton(controllerJoystick, 16);
        ...
        SmartDashboard.putData("Up Gear Position", new UpGearPosition());
        SmartDashboard.putData("Place Gear Position", new PlaceGearPosition());
        SmartDashboard.putData("Down Gear Position", new DownGearPosition());
        SmartDashboard.putData("Update PID Rotator", new UpdatePIDRotator());
        SmartDashboard.putData("Set Setpoint Rotator", new SetSetpointRotator());
