...
public class OI
{
    ...
    public JoystickButton receiveGearOut;
    public JoystickButton receiveGearIn;
	...
	public OI()
	{
        ...
        receiveGearIn = new JoystickButton(controllerJoystick, 5);
        receiveGearIn.whenReleased(new GearReceiveIn());
        receiveGearOut = new JoystickButton(controllerJoystick, 5);
        receiveGearOut.whenPressed(new GearReceiveOut());
