...
public class OI
{
    ...
    public JoystickButton gearFeederOn;
    public JoystickButton gearFeederOff;
	...
	public OI()
	{
        ...
        gearFeederOff = new JoystickButton(controllerJoystick, 13);
        gearFeederOff.whenReleased(new GearFeedStop());
        gearFeederOn = new JoystickButton(controllerJoystick, 13);
        gearFeederOn.whenPressed(new GearFeedStart());
        ...
        rotateGearDown.whenReleased(new GearRotateDown());
        rotateGearUp = new JoystickButton(controllerJoystick, 5);
        rotateGearUp.whenPressed(new GearRotateUp());
