...
public class OI {
    ...
    public OI() {
        ...
        shooterSpeedD.whenPressed(new ShooterSetSpeedD());
        shooterSpeedC = new JoystickButton(driveJoystick, 11);
        shooterSpeedC.whenPressed(new ShooterSetSpeedC());
        shooterSpeedB = new JoystickButton(driveJoystick, 10);
        shooterSpeedB.whenPressed(new ShooterSetSpeedB());
        shooterSpeedA = new JoystickButton(driveJoystick, 9);
        shooterSpeedA.whenPressed(new ShooterSetSpeedA());
        ...
        shootTrigger.whenPressed(new ShooterManualShoot(1000, 0));
