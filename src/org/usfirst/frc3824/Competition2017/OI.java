...
public class OI
{
	...
	public OI()
	{
        ...
        SmartDashboard.putData("Chassis Turn Angle: Right", new ChassisTurnAngle(90.0, 0.0, false));
        ...
        SmartDashboard.putData("Auto Place Gear Gyro", new AutoPlaceGearGyro());
        SmartDashboard.putData("Camera Servo Control", new CameraServoControl());
        SmartDashboard.putData("Auto Deliver Gear", new AutoDeliverGear());
