 ...
 *
 */
public class CameraServoControl extends Command
{
...
//		Robot.camera.controlCameraRotate(setpoint);
		...
		if (Robot.oi.driveJoystick.getRawAxis(3) < 0)
			Robot.camera.controlCameraRotate(false);
		else
