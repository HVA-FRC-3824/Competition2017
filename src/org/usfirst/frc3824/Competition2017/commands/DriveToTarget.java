...
public class DriveToTarget extends Command
{
	...
	protected void initialize()
	{
		...
		Robot.chassis.driveStraightPID(0.8, false);
	}

	// Called repeatedly when this Command is scheduled to run
	protected void execute()
	{
		// double distanceDelta = rpi.getTarget().calculateDistanceFromTarget()
		// - Constants.LIFT_DISTANCE;
	...
	{
		double distanceDelta = rpi.getTarget().calculateDistanceFromTarget() - Constants.LIFT_DISTANCE;
