 ...
 *
 */
public class ShooterEnableDisable extends Command
{
	...
	public ShooterEnableDisable(boolean Enable)
	{
	...
	{
		// Determine if the shooter motor should be enabled or disabled
		if (m_Enable == true)
