...
public class AutonomousPlaceGear extends CommandGroup
{
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	{
    		addSequential(new ChassisDriveDistance(190.0, 0.6, false));
    		addSequential(new ChassisTurnAngle(110.0, 0.5, false));
    		addSequential(new ChassisDriveRange(50.0, 0.5, false));
    	} else if (GearLocation == "middle")
    	{
    	...
    	addSequential(new AutoGearPlace());
	}
}
