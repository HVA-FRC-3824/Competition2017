...
public class ShooterManualShoot extends Command
{
	...
	public ShooterManualShoot(double ShooterSpeed, double FeederSpeed)
	{
	...
	{
		// Turn off teh shooter power
		Robot.shooter.setShooterPower(10.0);
	...
	protected void execute()
	{
		...
		if (timer.get() > 1.0)
			Robot.shooter.setFeederPower(-4.0);		
	}
